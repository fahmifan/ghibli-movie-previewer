...
export default (props) => {
  ...
  const closeIcon = (
    <svg
      ...
      className="h1 w1 fr ba center b--black-30 br-100 pa1 pointer dim"
  ...
  return (
    <span 
      className={`w-90 w-50-ns mh-70 scroll-x-auto mt3 mt5-ns bg-white fixed pa2 br3 tl z-200 helvetica shadow-3 ${isClose}`}>
      {closeIcon}
